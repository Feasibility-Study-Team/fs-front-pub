                        ...
                        <tr className="bg-white hover:bg-tablehover font-semibold text-admintext border-b border-tablehover" key={index}>
                            ...
                            <td className="py-4 px-6">
                                <div className="flex gap-1">
                                    <Link to={`${item?.id}`}><button className="h-8 w-16 rounded-full bg-[#3751FF] hover:bg-tablehover hover:border-[#3751FF] hover:border-2 hover:text-[#3751FF] text-white uppercase">Edit</button></Link>
                                    <button className="h-8 w-16 rounded-full bg-[#F12B2C] hover:bg-tablehover hover:border-[#F12B2C] hover:border-2 hover:text-[#F12B2C] text-white uppercase">Hapus</button>
                                </div>
                            </td>
                        </tr>
                    ))}
